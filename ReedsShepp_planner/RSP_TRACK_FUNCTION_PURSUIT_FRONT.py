"""
COMMENTS
This sorta works but since the perpendicular points are calculated from the front position
its not as good
lets write another code that takes rear position as a reference to calculate points from the path
"""
